...
const NotificationAlert: React.FC<NotificationAlertProps> = ({ notification }) => {
    ...
    // Map notification types to Material Tailwind Alert colors
    ...
    return (
        <Alert
            ...
            className="mb-4 shadow-2xl relative backdrop-blur-sm border-2 border-white/20 rounded-xl transform transition-all duration-300 ease-out hover:scale-105"
        >
